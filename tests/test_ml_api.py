...
def test_ml_endpoints():
    ...
    try:
        ...
        if response.status_code == 200:
            data = response.json()
            if data.get('success'):
                print(f"[OK] SUCCESS: Got {len(data.get('recommendations', []))} recommendations")
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if data.get('success'):
                ...
                print(f"[OK] SUCCESS: Found {len(similar)} similar children")
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if data.get('success'):
                ...
                print(f"[OK] SUCCESS: Generated {len(plan)} days")
                if plan:
                    day1 = plan[0]
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if data.get('success'):
                ...
                print(f"[OK] SUCCESS: Acceptance score: {prediction.get('acceptance_score', 0):.1f}%")
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if data.get('success'):
                ...
                print(f"[OK] SUCCESS: Profile generated")
    ...
    try:
        ...
        if response.status_code == 200:
            data = response.json()
            if data.get('success'):
                print(f"[OK] SUCCESS: Models trained")
    ...
    print("TEST COMPLETE")
    print("="*60)
    print("\n[OK] All ML Recommender endpoints are now integrated!")
    print("   Start your Flask app with: python flask_app.py")
    print("   Then run this test to verify functionality")

if __name__ == "__main__":
    print("\n[WARN]  Make sure Flask app is running on http://localhost:5000")
