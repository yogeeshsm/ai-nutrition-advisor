    ...
    try:
        ...
        try:
            ...
            if MYSQL_CONFIG['database'] in databases:
                print(f"[OK] Database '{MYSQL_CONFIG['database']}' exists")
            else:
                print(f"[WARN] Database '{MYSQL_CONFIG['database']}' does not exist")
        ...
        try:
            ...
            print(f"[OK] Successfully connected to '{MYSQL_CONFIG['database']}'")
            ...
            if "Unknown database" in str(e):
                print(f"[FAIL] Database '{MYSQL_CONFIG['database']}' doesn't exist")
                print("\nTo create it, run:")
        ...
        print("\n" + "=" * 60)
        print("[OK] MySQL is properly configured!")
        print("=" * 60)
        print("\nNext steps:")
        ...
        print("[FAIL] MySQL connector not installed")
        print("\nInstall it with:")
...
if __name__ == "__main__":
    ...
    if not success:
        print("\n[WARN] Please fix the issues above before proceeding")
        sys.exit(1)
